...
{
  $MooseX::TrackDirty::Attributes::Trait::Role::Application::ToClass::VERSION = '2.002';
}
...
This document describes version 2.002 of MooseX::TrackDirty::Attributes::Trait::Role::Application::ToClass - released November 24, 2012 as part of MooseX-TrackDirty-Attributes.
